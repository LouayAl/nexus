...
export function JobCard({ offre, featured = false, onApply, selectedId, forceActive = false }: JobCardProps) {
  ...
  const isConfidential = offre.entreprise_visible === false;
    ...
    >
      ...
      <div style={{
        ...
        background: isSelected
          ...
          : active ? "linear-gradient(90deg, #EE813D, #2284C0)" : "transparent",
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6, flexWrap: "wrap" }}>
          ...
          {isConfidential && (
            <span style={{ background: "rgba(176,196,212,0.15)", color: "#B0C4D4", fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 99 }}>
              🔒 Confidentiel
            </span>
          )}
        </div>
      ...
      {offre.langues && offre.langues.length > 0 && (
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
          ...
          {offre.langues.map(lang => (
            <span key={lang} style={{ fontSize: 11, fontWeight: 500, color: "#5A7A96", background: "rgba(16,64,107,0.05)", padding: "2px 8px", borderRadius: 6 }}>
              {lang}
            </span>
          ))}
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: isSelected
              ...
              : active ? "linear-gradient(135deg, #EE813D, #2284C0)" : "#F0F4F8",
            border: "none",
