    ...
    <AppShell pageTitle="Dashboard Recruteur">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 300px", gap: 16, marginBottom: 32 }}>
        ...
        <div style={{ background: "white", border: "1px solid rgba(16,64,107,0.08)", borderRadius: 20, padding: 24, boxShadow: "0 1px 6px rgba(16,64,107,0.05)" }}>
          ...
          <ResponsiveContainer width="100%" height={160}><BarChart data={offreBarData} margin={{ top: 4, right: 4, left: -40, bottom: 0 }}><CartesianGrid strokeDasharray="3 3" stroke="rgba(16,64,107,0.05)" /><XAxis dataKey="name" tick={{ fontSize: 8, fill: "#B0C4D4" }} axisLine={false} tickLine={false} /><YAxis tick={{ fontSize: 10, fill: "#B0C4D4" }} axisLine={false} tickLine={false} allowDecimals={false} /><Tooltip content={<ChartTooltip />} /><Bar dataKey="candidats" fill="#EE813D" radius={[6, 6, 0, 0]} name="Candidats" maxBarSize={34} /></BarChart></ResponsiveContainer>
        </div>
        <div style={{ background: "white", border: "1px solid rgba(16,64,107,0.08)", borderRadius: 20, padding: 24, boxShadow: "0 1px 6px rgba(16,64,107,0.05)" }}>
