...
const NAV_LINKS = [
  ...
  { href: "/company/dashboard", label: "Recruteurs"     },
  ...
  return (
    <>
      <header style={{
        ...
        {/* Logo */}
        <Link href="/discover" style={{ textDecoration: "none", flexShrink: 0, display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{
            width: 34, height: 34, borderRadius: 10,
            background: "linear-gradient(135deg, #EE813D, #2284C0)",
            display: "flex", alignItems: "center", justifyContent: "center",
            boxShadow: "0 4px 12px rgba(238,129,61,0.35)",
          }}>
            <span style={{ color: "white", fontSize: 16, fontWeight: 900, fontFamily: "'Fraunces', serif" }}>N</span>
          </div>
          <span className="font-display" style={{ fontSize: 20, fontWeight: 900, color: "#10406B", letterSpacing: "-0.02em" }}>
            nexus
          </span>
        </Link>
          ...
          <div style={{ position: "relative" }}>
            ...
            {userOpen && (
              <div style={{
                ...
                width: 200, borderRadius: 14, overflow: "hidden", zIndex: 200,
                background: "white", border: "1px solid rgba(16,64,107,0.1)",
                boxShadow: "0 12px 40px rgba(16,64,107,0.14)",
              }}>
                <div style={{ padding: "14px 16px", borderBottom: "1px solid rgba(16,64,107,0.07)" }}>
                  ...
                  <div style={{ fontSize: 11, color: "#5A7A96", marginTop: 2 }}>{user?.role}</div>
                </div>
